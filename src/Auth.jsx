  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: '.65rem', color: '#f5e070', opacity: .65, letterSpacing: '.1em', marginBottom: 40 }}>
          90-Day Foundations
        </p>
        ...
        {status === 'sent' ? (
          <div style={{ animation: 'fadeUp .4s both' }}>
            ...
            <p style={{ fontSize: '.7rem', color: '#f5e070', opacity: .65, marginTop: 12 }}>
              Check your email and click the link to sign in.
            </p>
            <button onClick={() => { setStatus('idle'); setEmail(''); }}
              style={{
                marginTop: 20, background: 'none', border: '1px solid rgba(240,192,64,.15)',
                color: '#f0c040', padding: '8px 20px', borderRadius: 8, fontSize: '.7rem',
